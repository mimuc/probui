...
public class ProbUICheckBox extends CheckBox implements ProbInteractor {


    public ProbInteractorCore core;

    public ProbUICheckBox(Context context) {
        super(context);
        sharedConstructor();
    }

    public ProbUICheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructor();
    }

    public ProbUICheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
