...
public abstract class PMLRuleBinary extends PMLRule {

    protected List<PMLRule> subrules = new ArrayList<PMLRule>();

    public PMLRuleBinary(String label) {
        super(label);
    }

    public void addRule(PMLRule rule) {
