...
public class OpdfTouchGaussianFactory implements OpdfFactory<OpdfTouchGaussian> {
     ...
     *                  object.
     */
    public OpdfTouchGaussianFactory(int dimension) {
        this.dimension = dimension;
    }


    public OpdfTouchGaussian factor() {
        return new OpdfTouchGaussian(dimension);
    }
}
