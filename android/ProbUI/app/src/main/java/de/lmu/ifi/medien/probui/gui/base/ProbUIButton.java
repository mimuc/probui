...
public class ProbUIButton extends Button implements ProbInteractor {
    ...
    public ProbUIButton(Context context) {

        super(context);
        sharedConstructor();
    }

    public ProbUIButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructor();
    }

    public ProbUIButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void sharedConstructor() {
        ...
        this.core.setBehavioursMaxObservations(10);
    }
    ...
    public void onProbSetup() {
        ...
        this.core.addRule("activated: tap on complete and tap is most_likely", new PMLRuleListener() {
            @Override
