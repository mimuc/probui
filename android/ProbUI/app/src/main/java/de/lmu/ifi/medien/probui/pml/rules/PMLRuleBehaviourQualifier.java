...
public abstract class PMLRuleBehaviourQualifier extends PMLRuleBehaviour {

    protected PMLRuleBehaviour rule;

    public PMLRuleBehaviourQualifier(String label, PMLRuleBehaviour rule) {
        super(rule.behaviour, label);
        this.rule = rule;
        this.label = label;
    }
