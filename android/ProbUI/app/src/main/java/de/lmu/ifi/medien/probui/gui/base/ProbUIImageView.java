...
public class ProbUIImageView extends ImageView implements ProbInteractor {
    ...
    public ProbUIImageView(Context context) {

        super(context);
        sharedConstructor();
    }

    public ProbUIImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructor();
    }

    public ProbUIImageView(Context context, AttributeSet attrs, int defStyleAttr) {
