...
{	
	...
	public static double[][] matrix(int r, int c)
	{
		if (r <= 0 || c <= 0)
	...
	public static double[][] matrix(int s)
	{
		return matrix(s, s);
	}


	public static double[][] matrix(int s, double v)
	{
		return matrix(s, s, v);
	}


	public static double[][] matrix(int r, int c, double v)
	{
		double[][] m = matrix(r, c);
	...
	public static double[][] matrix(double[] v)
	{
	...
	public static double[] vector(int dimension)
	{
	...
	public static double[][] matrixIdentity(int s)
	{
		double[][] m = matrix(s, s);
	...
	public static int nbRows(double[][] m)
	{
		return m.length;
	}


	public static int nbColumns(double[][] m)
	{
		return m[0].length;
	}


	public static int dimension(double[] v)
	{
		return v.length;
	}
	...
	public static double[][] decomposeCholesky(double[][] m)
	{
		if (!isSquare(m))
	 ...
	 * decomposition.
	 */
	public static double determinantCholesky(double[][] l)
	{
		if (!isSquare(l))
			throw new IllegalArgumentException("Matrix is not square");
	...
	/* Computes the inverse of a matrix given its cholesky matrix
	 decomposition. */
	public static double[][] inverseCholesky(double[][] l)
	{
		if (!isSquare(l))
			throw new IllegalArgumentException("Matrix is not square");
	...
	public static double[][] lowerTriangularInverse(double[][] m)
	{
		if (!isSquare(m))
			throw new IllegalArgumentException("Matrix is not square");
